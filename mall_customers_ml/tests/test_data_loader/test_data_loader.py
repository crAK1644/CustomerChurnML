...
class TestDataLoader:
    ...
    def test_load_data_file_not_exists(self):
        ...
        with pytest.raises(FileNotFoundError, match="The file nonexistent.csv does not exist."):
            loader.load_data()
    ...
    def test_load_data_unexpected_error(self, mock_exists, mock_read_csv):
        ...
        loader = DataLoader("test.csv")
        with pytest.raises(Exception, match="Unexpected error loading data: Unexpected error"):
            loader.load_data()
